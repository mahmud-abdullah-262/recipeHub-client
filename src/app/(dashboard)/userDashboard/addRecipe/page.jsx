...
const addRecipePage = async() => {
  ...
  const plan = await getPlan(`/api/plans?planId=${user.plan}`)
  ...
  return (
    <div className=' p-4'>
      ...
      <p className='text-sm font-bold text-secondary'>You are a {user.plan} user. you can post {plan.maxRecipePost} recipes.</p>
      </div>
